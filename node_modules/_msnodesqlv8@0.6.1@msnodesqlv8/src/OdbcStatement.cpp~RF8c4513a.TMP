...
namespace mssql
{
	...
	*/
	...
	bool OdbcStatement::try_prepare(const shared_ptr<QueryOperationParams> &q)
	{
		...
		SQLSetStmtAttr(statement, SQL_ATTR_ROW_ARRAY_SIZE, reinterpret_cast<SQLPOINTER>(rows_to_bind), 0);
		auto reserved=  _preparedStorage->reserve(_resultset, rows_to_bind);
