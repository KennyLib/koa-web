...
suite('date tests', function () {
  ...
  test('test timezone offset correctly offsets js date type', function (testDone) {
  ...
  test('date to millisecond verification', function (testDone) {
    ...
    var fns = [
      function (asyncDone) {
        theConnection.queryRaw('DROP TABLE date_diff_test', function () {
          asyncDone()
        })
      },
  ...
  test('time to millisecond components', function (testDone) {
    ...
    var fns =
      [
        function (asyncDone) {
          theConnection.queryRaw('DROP TABLE time_test', function () {
            asyncDone()
          })
        },
        function (asyncDone) {
        ...
        function (asyncDone) {
          ...
          theConnection.queryRaw(query, function (e) {
            assert.ifError(e)
            asyncDone()
          })
        },
        ...
        function (asyncDone) {
          theConnection.queryRaw('TRUNCATE TABLE time_test', function (e) {
            assert.ifError(e)
            asyncDone()
          })
        },
  ...
  test('test timezone components of datetimeoffset', function (testDone) {
    var tzYear = 1970
    var tzMonth = 0
    var tzDay = 1
    var tzHour = 0
    ...
    var fns =
      [
        function (asyncDone) {
          theConnection.queryRaw('DROP TABLE datetimeoffset_test', function () {
            asyncDone()
          })
        },
        function (asyncDone) {
